...
public class RedirectController {
	...
	public String studentURL1(Model model) {
		...
		//redirect는 풀경로를 사용할수 있다 
		return "redirect:http://localhost:8288/spring_14_3_ex1_srpingex(redirect)/studentURL1.jsp";
	}
	...
	public String studentURL22(Model model) {
		...
		return "redirect:http://localhost:8288/spring_14_3_ex1_srpingex(redirect)/studentURL2.jsp";
	}
